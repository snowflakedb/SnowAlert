...
GRANT_PRIVILEGES_QUERIES = [
    ...
    f'ALTER SCHEMA {DATA_SCHEMA} ENABLE MANAGED ACCESS',
    f'GRANT SELECT ON FUTURE VIEWS IN SCHEMA {DATA_SCHEMA} TO ROLE {ROLE}',
    # f'GRANT SELECT ON FUTURE FUNCTIONS IN SCHEMA {DATA_SCHEMA} TO ROLE {ROLE}',
    f'ALTER SCHEMA {RULES_SCHEMA} ENABLE MANAGED ACCESS',
    f'GRANT SELECT ON FUTURE VIEWS IN SCHEMA {RULES_SCHEMA} TO ROLE {ROLE}',
    f'GRANT INSERT ON ALL TABLES IN SCHEMA {RESULTS_SCHEMA} TO ROLE {ROLE}',
