...
SUPPLEMENTARY_TABLES = {
    ...
    'managed_devices': [
        ...
        ('user_id', 'STRING'),
        ('device_name', 'STRING'),
        ('managed_device_owner_type', 'VARIANT'),
        ('device_action_results', 'VARIANT'),
        ('enrolled_date_time', 'TIMESTAMP_LTZ'),
        ('last_sync_date_time', 'TIMESTAMP_LTZ'),
        ('operating_system', 'STRING'),
        ('compliance_state', 'VARIANT'),
        ('jail_broken', 'STRING'),
        ('management_agent', 'VARIANT'),
        ('os_version', 'STRING'),
        ('eas_activated', 'BOOLEAN'),
        ('eas_device_id', 'STRING'),
        ('eas_activation_date_time', 'TIMESTAMP_LTZ'),
        ('azure_a_d_registered', 'BOOLEAN'),
        ('device_enrollment_type', 'VARIANT'),
        ('activation_lock_bypass_code', 'STRING'),
        ('email_address', 'STRING'),
        ('azure_a_d_device_id', 'STRING'),
        ('device_registration_state', 'VARIANT'),
        ('device_category_display_name', 'STRING'),
        ('is_supervised', 'BOOLEAN'),
        ('exchange_last_successful_sync_date_time', 'TIMESTAMP_LTZ'),
        ('exchange_access_state', 'VARIANT'),
        ('exchange_access_state_reason', 'VARIANT'),
        ...
        ('manufacturer', 'STRING'),
        ('imei', 'STRING'),
        ('compliance_grace_period_expiration_date_time', 'TIMESTAMP_LTZ'),
