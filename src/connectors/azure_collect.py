...
SUPPLEMENTARY_TABLES = {
    ...
    'users': [
        ...
        ('refresh_tokens_valid_from', 'TIMESTAMP_LTZ'),
...
API_SPECS = {
    ...
    'managed_devices': {
        'request': {'path': '/v1.0/deviceManagement/managedDevices', 'host': 'graph.microsoft.com'},
        'response': {
            'headerDate': 'recorded_at',
            'tenantId': 'tenant_id',
            'subscriptionId': 'subscription_id',
            ...
            'enrolledDateTime': 'enrolled_date_time',
            'lastSyncDateTime': 'last_sync_date_time',
            ...
            'easActivationDateTime': 'eas_activation_date_time',
            ...
            'exchangeLastSuccessfulSyncDateTime': 'exchange_last_successful_sync_date_time',
            ...
            'imei': 'imei',
            'complianceGracePeriodExpirationDateTime': 'compliance_grace_period_expiration_date_time',
