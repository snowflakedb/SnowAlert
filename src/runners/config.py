...
CONNECTOR_METADATA_TABLE_NAME = environ.get('SA_CONNECTOR_METADATA_TABLE_NAME', 'ingestion_metadata')
...
CONNECTOR_METADATA_TABLE = environ.get('SA_METADATA_CONNECTOR_TABLE', f"{RESULTS_SCHEMA}.{CONNECTOR_METADATA_TABLE_NAME}")
