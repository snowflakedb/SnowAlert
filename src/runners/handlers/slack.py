...
def handle(alert, recipient_email=None, channel=None, template=None, message=None, slack_api_token=None):
    if 'SLACK_API_TOKEN' not in os.environ and slack_api_token is None:
        log.info(f"No SLACK_API_TOKEN found, skipping handler.")
        return None
